...
const connectionUrl = process.env.RAILWAY_MYSQL_URL || process.env.DATABASE_URL || 'mysql://root:EflojxKqSWNDCULGMJZuezzHSqkaBIQr@yamanote.proxy.rlwy.net:10297/railway';
